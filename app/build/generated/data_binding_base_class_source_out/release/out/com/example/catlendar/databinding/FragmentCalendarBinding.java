...
public final class FragmentCalendarBinding implements ViewBinding {
  ...
  private FragmentCalendarBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull RecyclerView recyclerViewEvents, @NonNull TextView textEmptyState,
  ...
  public static FragmentCalendarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentCalendarBinding((ConstraintLayout) rootView, calendarView, fabAddEvent,
          recyclerViewEvents, textEmptyState, topAppBar);
    }
